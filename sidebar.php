...
<aside id="sidebar" class="hidden-md-down <?php echo odin_classes_page_sidebar_aside(); ?>" role="complementary">
	<div class="wengosense-cached">
		<h3><?php _e( 'Esotéricos e videntes disponíveis agora', 'odin' ); ?></h3>
		<?php
